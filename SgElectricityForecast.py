...
df['Electricity_Consumption'] = pd.to_numeric(df['Electricity_Consumption'])
print(type(df['Electricity_Consumption'][0]))
...
def test_stationarity(timeseries):
    ...
    adft = adfuller(timeseries['Electricity_Consumption'], autolag='AIC')
...
#Perform one operation out of two detrending process and differencing
...
residual = pd.DataFrame({'Electricity_Consumption':residual.values})
...
print('RSS : %f' %sum((result_AR.fittedvalues-df_log_diff["Electricity_Consumption"])**2)) 
